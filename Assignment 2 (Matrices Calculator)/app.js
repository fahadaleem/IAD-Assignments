...
function addscalor() {                          //function to get scalor to add to matrix
    ...
    addsc.innerHTML = '<label for="addsc">Enter scalor number to add to the matrix: </label><input type="number" name="" id="addsc"><button onclick="sumscalor()" id="submit-btn>Enter</button>'
...
function multiplyscalor() {                     //function to get scalor to multiply to matrix
    ...
    mulsc.innerHTML = '<label for="mulsc">Enter scalor number to Multiply to the matrix: </label><input type="number" name="" id="mulsc"><button onclick="mulscalor()" id="submit-btn">Enter</button>'
